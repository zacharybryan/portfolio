    ...
    return (
      <Router>
        <Container className="p-0" fluid='true'>
          ...
          <Route exact path={process.env.PUBLIC_URL + "/" +"portfolio"} component={HomePage} title={this.state.home.title} render={() => <HomePage title={this.state.home.title} text={this.state.home.text} />}  />
